...
{
    internal static class MethodInvokerAsyncStateMachineFactory
    {
        ...
        {
            var typeName = string.Format("AspectSharp.AsyncStateMachines.CustomContexts.{0}_{1}", callerMethod.DeclaringType.Name, callerMethod.Name);
