...
namespace AspectSharp.Tests.Net9.Abstractions.Attributes
{
    ...
    {
        public ExcludeAspectsFromTypeDefinitionToThisPropertyAttributeTests(SaveFixtures _) { }
        ...
        {
            var sut = new ExcludeAspectsFromTypeDefinitionToThisPropertyAttribute(expectedMethod);
