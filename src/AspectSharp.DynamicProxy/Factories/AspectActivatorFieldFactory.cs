...
namespace AspectSharp.DynamicProxy.Factories
{
    internal static class AspectActivatorFieldFactory
    {
        ...
        private static readonly MethodInfo _newContextActivatorUsingStringRepresentationMethodInfo = typeof(ProxyFactoryUtils).GetMethod(nameof(ProxyFactoryUtils.NewContextActivatorUsingStringRepresentationMethodInfo), new Type[] { typeof(Type), typeof(Type), typeof(Type), typeof(string) });
